...
=====================
This project contains the code used for obtaining the 9th position
on the MAFAT Radar Challenge.
...
Summary of the solution can be found in solution_summary.md. 
...
::
  ...
  │    │   └── samplers.py
  │    │
  │    ├── notebooks/ - notebooks used during competition
  │    │
...
.. code-block::
  ...
  $ pytest tests
  $ mafat_radar_challenge train -c experiments/config.yml
...
.. code-block::
  ...
  mafat_radar_challenge train -c experiments/config.yml -r path/to/checkpoint
